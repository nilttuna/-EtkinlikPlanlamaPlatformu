<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profiller.aspx.cs" Inherits="Yaz_Lab1_Proje2.Profiller" %>
...
<head>
    ...
    <title>Etkinlik Platformu - Profiller Sayfası</title>
    <style>
        /* Temel Stil Ayarları */
        * {
            margin: 0;
        ...
        .user-list {
            display: grid;
            grid-template-columns: repeat(5, 1fr); /* Her satırda bes kart */
            gap: 15px;
        }
...
<body>
 ...
 <asp:Label ID="lblMesaj" runat="server" CssClass="error-message" Visible="false" />
        <div class="content">
            <div class="container">
