<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yaz_Lab1_Proje2.AnaSayfa" %>
...
<head>
    ...
    <title>Etkinlik Platformu - Ana Sayfa</title>
    <style>
        /* Temel Stil Ayarları */
        * {
            margin: 0;
...
<body>
    ...
    <header>
        ...
        <div class="search-bar">
                <asp:Label ID="lblMessage" Text="Puanınız:" runat="server"  Visible="true"></asp:Label>
        </div>
        <div class="user-menu">
    ...
    <div class="event-list">
        ...
        <!-- Katıldığınız Etkinlikler Konteyneri -->
    ...
    <!-- Etkinlik Ekleme Butonu -->
    <a href="\YeniEtkinlik.aspx" class="add-event-btn">+</a>
