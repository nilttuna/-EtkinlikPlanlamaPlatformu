<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rapor.aspx.cs" Inherits="Yaz_Lab1_Proje2.Rapor" %>
...
<head>
    ...
    <title>Etkinlik Platformu - Rapor</title>
    <style>
        /* Temel Stil Ayarları */
        * {
            margin: 0;
        ...
        .content {
            flex: 1;
            padding: 20px;
            max-width: 1000px; /* Konteyner genişliği */
            margin: 0 auto;
            display: flex;
            gap: 20px;
        }
    ...
    /* Genişlik ve ortalama için eklemeler */
...
<body>
    ...
    <!-- Ana İçerik Alanı -->
            ...
            <div class="container">
    <h2>Etkinlik Platform Raporu</h2>
